...
const RegisterScreen = (props) => {
  ...
  let index=0;
  const dataAsis = [
    { key: index++, label: 'Ninguna', valor:'Alexa' },
    { key: index++, label: 'Dislexia', valor:'Okey, Google' },
    { key: index++, label: 'Visión Reducida', valor:'Ciri' },
    { key: index++, label: 'Daltonismo', valor:'Cortana' },
